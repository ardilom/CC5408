...
var scenes_tiles_size = 20*16

var target_size = 40

var rooms_1door = [preload("res://Rooms_grandes/Room1.2G.tscn"), preload("res://Rooms_grandes/Room1.3G.tscn"), 
preload("res://Rooms_grandes/Room1.4G.tscn"), preload("res://Rooms_grandes/Room1.5G.tscn"), preload("res://Rooms_grandes/Room1.1G.tscn"), ]
var rooms_2_long = [preload("res://Rooms_grandes/Room2.1G.tscn")]
var rooms_2_L = [preload("res://Rooms_grandes/Room2.2LG.tscn")]
var rooms_3 = [preload("res://Rooms_grandes/Room3.1G.tscn")]
var rooms_4 = [preload("res://Rooms_grandes/Room4.1G.tscn"), preload("res://Rooms_grandes/Room4.2G.tscn"), preload("res://Rooms_grandes/Room4.3G.tscn")]
var rooms_start = [preload("res://Rooms_grandes/Room4.2G.tscn")]
var rooms_boss = [preload("res://Rooms_grandes/Room1.2G.tscn")]
...
func run_generation():
	add_child_below_node(get_node("Character"),load("res://Scene/Character.tscn").instance())
...
func instantiate_room(room_scene , coord : Vector2, rotation : float):
	...
	add_child_below_node(get_node("Map"),room)
